...
export const locations = [
  ...
  },
  {
    ...
    description: 'PC- og Mac-reparation til Helsingør — afhentning, levering eller indsendelse. Værksted i Frederiksberg. Fejlsøgning fra 300 kr.',
    h1: 'Computerreparation — Helsingør', subhead: 'Vi har allerede kunder fra Helsingør — sådan fungerer det',
    intro: [
      'Helsingør ligger cirka 45 km fra vores værksted i Frederiksberg — for langt til et hurtigt besøg, men vi har allerede rigtige kunder herfra. De fleste aftaler enten afhentning/levering eller indsendelse, i stedet for personligt fremmøde, selvom du naturligvis er velkommen, hvis du alligevel er i København.',
    ...
    faq: [
      { q: 'Tilbyder I afhentning og levering til Helsingør?', a: 'Ja, kontakt os for at aftale det ud fra din placering.' },
      { q: 'Kan jeg sende mit device i stedet?', a: 'Ja, kontakt os først for instruktioner, inden du sender noget.' },
    ],
  ...
  },
  {
    ...
    description: 'PC- og Mac-reparation til Hillerød — afhentning, levering eller indsendelse. Værksted i Frederiksberg. Fejlsøgning fra 300 kr.',
    h1: 'Computerreparation — Hillerød', subhead: 'Afhentning, levering eller indsendelse for kunder i Hillerød',
    intro: ['Hillerød ligger cirka 35 km fra vores værksted i Frederiksberg. Vi arrangerer afhentning/levering eller indsendelse for kunder i denne afstand, ved siden af 300 kr. (2–4 dage) eller ekspres (600 kr., 1–2 timer) fejlsøgning.'],
    faq: [
      { q: 'Er afhentning/levering muligt for Hillerød?', a: 'Ja, kontakt os for at aftale det ud fra din placering.' },
      { q: 'Kan jeg sende mit device i stedet?', a: 'Ja, kontakt os først for forsendelsesinstruktioner, inden du sender noget.' },
    ],
    crosslinks: [{ label: 'København (oversigt)', href: '/computerreparation-koebenhavn/' }, { label: 'Kontakt', href: '/kontakt/' }],
  },
  {
    ...
    description: 'PC- og Mac-reparation til Roskilde — afhentning, levering eller indsendelse. Værksted i Frederiksberg. Fejlsøgning fra 300 kr.',
    h1: 'Computerreparation — Roskilde', subhead: 'Afhentning, levering eller indsendelse for kunder i Roskilde',
    intro: ['Roskilde ligger cirka 35 km fra vores værksted i Frederiksberg. Vi arrangerer afhentning/levering eller indsendelse for kunder i denne afstand, ved siden af 300 kr. (2–4 dage) eller ekspres (600 kr., 1–2 timer) fejlsøgning.'],
    faq: [
      { q: 'Er afhentning/levering muligt for Roskilde?', a: 'Ja, kontakt os for at aftale det ud fra din placering.' },
      { q: 'Kan jeg sende mit device i stedet?', a: 'Ja, kontakt os først for forsendelsesinstruktioner, inden du sender noget.' },
    ],
    crosslinks: [{ label: 'København (oversigt)', href: '/computerreparation-koebenhavn/' }, { label: 'Kontakt', href: '/kontakt/' }],
  },
  {
    ...
    description: 'PC- og Mac-reparation til Køge — afhentning, levering eller indsendelse. Værksted i Frederiksberg. Fejlsøgning fra 300 kr.',
    h1: 'Computerreparation — Køge', subhead: 'Afhentning, levering eller indsendelse for kunder i Køge',
    intro: ['Køge ligger cirka 40 km fra vores værksted i Frederiksberg. Vi arrangerer afhentning/levering eller indsendelse for kunder i denne afstand, ved siden af 300 kr. (2–4 dage) eller ekspres (600 kr., 1–2 timer) fejlsøgning.'],
    faq: [
      { q: 'Er afhentning/levering muligt for Køge?', a: 'Ja, kontakt os for at aftale det ud fra din placering.' },
      { q: 'Kan jeg sende mit device i stedet?', a: 'Ja, kontakt os først for forsendelsesinstruktioner, inden du sender noget.' },
    ],
    crosslinks: [{ label: 'København (oversigt)', href: '/computerreparation-koebenhavn/' }, { label: 'Kontakt', href: '/kontakt/' }],
  },
  {
    ...
    description: 'PC- og Mac-reparation til Nykøbing Falster — indsendelse eller aftalt levering. Værksted i Frederiksberg. Fejlsøgning fra 300 kr.',
    h1: 'Computerreparation — Nykøbing Falster', subhead: 'Længere væk, men vi har allerede rigtige kunder herfra',
    intro: [
      'Nykøbing Falster ligger cirka 130 km fra vores værksted i Frederiksberg — virkelig langt væk, men vi har allerede rigtige kunder fra dette område. På denne afstand er indsendelse normalt den mest praktiske løsning, selvom levering/afhentning kan aftales afhængigt af din konkrete situation.',
      'Standardfejlsøgning koster 300 kr. (2–4 dage), eller ekspres for 600 kr. (1–2 timer) — leveringstiden starter, når dit device faktisk når frem til værkstedet.',
    ],
    faq: [
      { q: 'Kan det virkelig betale sig at sende et device så langt for reparation?', a: 'Vi har allerede kunder, der gør præcis det — kontakt os, så er vi ærlige omkring, om det giver mening for din konkrete situation.' },
      { q: 'Hvordan fungerer indsendelse?', a: 'Kontakt os først for forsendelsesinstruktioner og en idé om processen, inden du sender noget.' },
    ],
    crosslinks: [{ label: 'København (oversigt)', href: '/computerreparation-koebenhavn/' }, { label: 'Kontakt', href: '/kontakt/' }],
  },
];
